...
/*
ejecutar un servidor web temporal,
redireccionar al usuario a un extremo en GitHub en el navegador web,
esperar a que el usuario complete el flujo de autorización en el navegador y controlar una llamada de redireccionamiento de GitHub que incluye el código (que luego debe convertirse en un token de OAuth2 con una llamada diferente a los servidores de la API de GitHub).
*/

final _authorizationEndpoint =
    Uri.parse('https://github.com/login/oauth/authorize');
final _tokenEndpoint = Uri.parse('https://github.com/login/oauth/acces_token');
